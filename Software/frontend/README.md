...
The application is deployed after a merge to the dev-branch. The environment variables are being set on the remote server.
...
runs eslint and fixes errors that can be automatically fixed
