...
class MotorSlider:
    ...
    def readState(self):
        pos = self.readPCT()
        if pos > 0.834: return 3 # Online state
        elif pos > 0.5: return 2 # Local network state
        elif pos > 0.166: return 1 # Access point state
        else: return 0 # Offline / manual state
