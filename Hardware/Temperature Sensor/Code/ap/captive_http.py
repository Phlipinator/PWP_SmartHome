...
class HTTPServer(Server):
    def __init__(self, poller, local_ip, htmlBuilder):
    ...
    def login(self, params):
        ...
        self.htmlBuilder.ssid = ssid.decode("utf-8")
        self.htmlBuilder.pw = password.decode("utf-8")
        self.htmlBuilder.writeToIndex()

        print("Saved ssid and password")
